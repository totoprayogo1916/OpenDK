...
<section class="content container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {{ html()->form('POST', route('data.anggaran-realisasi.do_import'))->id('form-import')->class('form-horizontal form-label-left')->attributes(['enctype' => 'multipart/form-data'])->open() }}
