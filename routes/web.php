...
Route::group(['middleware' => ['installed', 'xss_sanitization']], function () {
    ...
    Route::group(['middleware' => 'auth:web'], function () {
        ...
        Route::group(['prefix' => 'setting'], function () {
            // User Management
            Route::group(['prefix' => 'user','middleware' => ['role:super-admin|administrator-website'], 'controller' => UserController::class], function () {
            ...
            // Role Management
            Route::group(['prefix' => 'role', 'middleware' => ['role:super-admin|administrator-website'], 'controller' => RoleController::class], function () {
            ...
            // Komplain Kategori
            Route::group(['prefix' => 'komplain-kategori', 'middleware' => ['role:super-admin|admin-komplain|administrator-website'], 'controller' => KategoriKomplainController::class], function () {
            ...
            // Tipe Regulasi
            Route::group(['prefix' => 'tipe-regulasi', 'middleware' => ['role:super-admin|administrator-website'], 'controller' => TipeRegulasiController::class], function () {
            ...
            // Jenis Penyakit
            Route::group(['prefix' => 'jenis-penyakit','middleware' => ['role:super-admin|admin-puskesmas|administrator-website'], 'controller' => JenisPenyakitController::class], function () {
            ...
            // Tipe Potensi
            Route::group(['prefix' => 'tipe-potensi','middleware' => ['role:super-admin|administrator-website'], 'controller' => TipePotensiController::class], function () {
            ...
            // Slide
            Route::group(['prefix' => 'slide','middleware' => ['role:super-admin|administrator-website'], 'controller' => SlideController::class], function () {
            ...
            // COA
            Route::group(['prefix' => 'coa','middleware' => ['role:super-admin|administrator-website'], 'controller' => COAController::class], function () {
            ...
            Route::group(['prefix' => 'aplikasi','middleware' => ['role:super-admin|administrator-website'], 'controller' => AplikasiController::class], function () {
            ...
            Route::group(['prefix' => 'info-sistem','middleware' => ['role:super-admin|administrator-website'], 'controller' => LogViewerController::class], function () {
